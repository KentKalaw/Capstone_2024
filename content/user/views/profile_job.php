    ...
    <option value="Junior Cybersecurity Specialist">Junior Cybersecurity Specialist</option>
    <option value="Cybersecurity Specialist">Cybersecurity Specialist</option>
    <option value="Senior Cybersecurity Specialist">Senior Cybersecurity Specialist</option>
    ...
    <option value="Junior System Administrator">Junior System Administrator</option>
    ...
    <option value="User Experience Researcher">User Experience Researcher</option>
    <option value="Interaction Designer">Interaction Designer</option>

    <optgroup label="Additional IT-related">
    ...
    <option value="Public School Teacher">Public School Teacher</option>
    <option value="Social Worker">Social Worker</option>
    <option value="Customs Officer">Customs Officer</option>
    <option value="Barangay Captain">Barangay Captain</option>

    <optgroup label="Creative and Media">
    ...
    <option value="Radio Announcer">Radio Announcer</option>
    <option value="Actor/Actress">Actor/Actress</option>
    <option value="Musician">Musician</option>

    <optgroup label="Construction and Labor">
    <!-- Construction and Labor Sector -->
    ...
    <optgroup label="Agriculture and Fisheries">
    <!-- Agriculture and Fisheries Sector -->
    <option value="Farmer">Farmer</option>
    <option value="Fisherman">Fisherman</option>
    <option value="Agriculturist">Agriculturist</option>
    <option value="Veterinarian">Veterinarian</option>
    <option value="Fisheries Specialist">Fisheries Specialist</option>
