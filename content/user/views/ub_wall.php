...
<?php include_once('./loader/loader.php'); ?>
  ...
  <div id="page-content-wrapper">
    ...
    <div class="col-md-5">
        <h3 class="text-themecolor" style="font-size: 1.5em; color:#752738 !important; margin-bottom: 5px;">UB Wall</h3>
    ...
    <h2 class="fs-4 my-2 b-0 pt-4 px-1" style="color:#752738">Programs, News, and Updates</h2>
