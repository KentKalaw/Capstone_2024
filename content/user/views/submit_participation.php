...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($check_result->num_rows > 0) {
            ...
            if ($conn->query($insert_sql) === TRUE) {
                try {
                    ...
                    $mail->Subject = 'Alumnite Participation Request Submitted!';
                    $mail->Body = '
    <html>
    <head>
        <style>
    ...
    <body>
        <div class="email-container">
            <h1>Thank you for your Participation request, <span class="highlight">'.$fname.' '.$lname.'</span>!</h1>
            <p>We’ve received your participation request for the upcoming event.</p>
