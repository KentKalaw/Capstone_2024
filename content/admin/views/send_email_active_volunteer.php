...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    echo "<script>alert('Email sent successfully!'); window.location.href='active_events_volunteer.php';</script>";
} catch (Exception $e) {
    echo "<script>alert('Mailer Error: {$mail->ErrorInfo}'); window.location.href='active_events_volunteer.php';</script>";
}}
?>