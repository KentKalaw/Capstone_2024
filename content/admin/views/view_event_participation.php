...
$participation_sql = "SELECT * FROM events_participation WHERE event_id = $event_id AND participationStatus = 'pending'";
...
<nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 border-bottom" id="top-bar">
    ...
    <div class="col-md-5">
        <h3 class="text-themecolor" style="font-size: 1.5em; color:#752738 !important; margin-bottom: 5px;">Event Participation</h3>
        <ol class="breadcrumb mb-0">
            <li class="breadcrumb-item"><a href="javascript:void(0)" style="color:#000 !important;">Home</a></li>
            <li class="breadcrumb-item active">Event Participation</li>
        </ol>
    </div>
</div>
    ...
    <div class="container-fluid mt-3">
        <div class="d-flex justify-content-start mb-3 button-group">
            ...
            <button class="btn btn-outline-dark me-2" style="box-shadow: none;" onclick="window.location='view_approved_participation.php?event_id=<?php echo $event_id; ?>'">Approved Participation</button>
                            ...
                            if ($participation_result->num_rows > 0) {
                                while ($row = $participation_result->fetch_assoc()) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                <form action='update_participation_status.php' method='post' style='display:inline;'>
