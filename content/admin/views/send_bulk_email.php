...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($emails && $subject && $body) {
        ...
        try {
            ...
            echo "<script>alert('Emails sent successfully!'); window.location.href='view_approved_participation.php?event_id=" . $event_id . "';</script>";
        } catch (Exception $e) {
            echo "<script>alert('Mailer Error: {$mail->ErrorInfo}'); window.location.href='view_approved_participation.php?event_id=" . $event_id . "';</script>";
        }
    } else {
        echo "<script>alert('Please fill in all fields.'); window.location.href='view_approved_participation.php?event_id=" . $event_id . "';</script>";
    }
}
?>