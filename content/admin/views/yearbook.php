...
<h2 class="fs-4 my-5 b-0 pt-4 px-3 text-center" style="color:#752738"><strong>Yearbook Delivery Request Table</strong></h2>
    ...
    <div class="d-flex justify-content-start mb-3 button-group">
        ...
        <button class="btn btn-outline-secondary me-2" style="box-shadow: none;" onclick="window.location='view_approved_yearbook.php'">Approved Yearbook Delivery</button>
      </div>
      ...
      <div class="card w-100" style="border-radius:10px;padding:10px">
        <table class="table vm no-th-brd pro-of-month" style="border-radius:10px" id="example">
          ...
          <?php
                include('../../connect.php');
                $sql2 = "SELECT * FROM yearbook WHERE request_status = 'Pending'";
                ...
                while($row2 = $result2->fetch_assoc()) {
                    ...
                    echo '<td><center>
                    <form action="update_yearbook_status.php" method="post" style="display:inline;">
