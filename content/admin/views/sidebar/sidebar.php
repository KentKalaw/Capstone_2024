...
<div class="d-flex" id="wrapper">
  ...
  <a href="feature_alumni.php" class="list-group-item list-group-item-action <?php echo $current_page == 'feature_alumni.php' ? 'active' : ''; ?>">
    <i class="fa-solid fa-user-graduate me-3" aria-hidden="true"></i>Featured Alumni
  </a>

  <a href="forums.php" class="list-group-item list-group-item-action <?php echo $current_page == 'forums.php' ? 'active' : ''; ?>">
    <i class="fa fa-users me-3" aria-hidden="true"></i>Forums
  </a>

  <a href="#" class="list-group-item list-group-item-action <?php echo $current_page == '#' ? 'active' : ''; ?>">
    <i class="fa-solid fa-hand-holding-heart me-3" aria-hidden="true"></i>Initiative Programs
  </a>

  <a href="events.php" class="list-group-item list-group-item-action <?php echo $current_page == 'events.php' ? 'active' : ''; ?>">
  ...
  <a href="yearbook.php" class="list-group-item list-group-item-action <?php echo $current_page == 'yearbook.php' ? 'active' : ''; ?>">
    <i class="fa fa-newspaper me-3" aria-hidden="true"></i>Yearbook
  </a>

  <a href="ub_wall.php" class="list-group-item list-group-item-action <?php echo $current_page == 'ub_wall.php' ? 'active' : ''; ?>">
    <i class="fa fa-map me-3" aria-hidden="true"></i>UB Wall
  </a>

  <a href="gts.php" class="list-group-item list-group-item-action <?php echo $current_page == 'gts.php' ? 'active' : ''; ?>">
    <i class="fa fa-file me-3" aria-hidden="true"></i>GTS
  </a>

  <a href="system_analytics.php" class="list-group-item list-group-item-action <?php echo $current_page == 'system_analytics.php' ? 'active' : ''; ?>">
    <i class="fa fa-bar-chart me-3" aria-hidden="true"></i>System Analytics
  </a>

  <a href="system_logs.php" class="list-group-item list-group-item-action <?php echo $current_page == 'system_logs.php' ? 'active' : ''; ?>">
