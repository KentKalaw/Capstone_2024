...
<head>
  ...
  <link rel="stylesheet" href="../css/feature_alumni.css" />
</head>
...
<?php include_once('./loader/loader.php'); ?>
  ...
  <div id="page-content-wrapper">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4 border-bottom" id="top-bar">
      <div class="d-flex align-items-center justify-content-between w-100">
        <div class="d-flex align-items-center">
          ...
          <h2 class="fs-4 m-0" style="color:#752738">Update Feature Alumni</h2>
        </div>
    ...
    <h2 class="fs-4 mb-2 pt-2 px-3" style="color:#752738; margin-top:20px;">Update Feature Alumni</h2>
